 ...
 */
@SessionScoped
public class User_RoleDao implements Serializable {

    private DBManager dbm;
    final private String table_name = "user_role";
    final private String first_table_name = "user";
    final private String second_table_name = "role";

    public User u;
    public int saveUserRole(User_Role userRole) {
        //1
        Statement st;
        int result = 0;
        ...
        try {
            ...
            //3
            String sqlKomudu = "INSERT INTO " + table_name + " (user_id, role_id) VALUES "
